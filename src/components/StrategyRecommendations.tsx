    ...
    const recommendations: Strategy[] = [
        {
            ...
            type: 'bullish',
            description: 'NIFTY showing upward momentum with low volatility',
            riskLevel: 'low',
            expectedReturn: '8-12%',
            marketCondition: 'Bullish trend with consolidation',
            instruments: ['NIFTY 19500 CE', 'NIFTY 19700 CE'],
            icon: TrendingUp,
        ...
        },
        {
            ...
            name: 'Iron Condor',
            type: 'neutral',
            description: 'BANKNIFTY in tight range, high time decay potential',
            riskLevel: 'medium',
            expectedReturn: '5-8%',
            marketCondition: 'Range-bound with low volatility',
            instruments: ['BANKNIFTY 44000 PE', 'BANKNIFTY 44500 CE'],
            icon: Shield,
        ...
        },
        {
            ...
            name: 'Long Straddle',
            type: 'neutral',
            description: 'High IV expected on earnings announcement',
            riskLevel: 'high',
            expectedReturn: '15-25%',
            marketCondition: 'High volatility expected',
            instruments: ['RELIANCE ATM CE', 'RELIANCE ATM PE'],
            icon: Zap,
